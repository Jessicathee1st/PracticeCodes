...
int main() {
        ...
        std::cin >> k;
        bool isAscending = (i<j<k); //Replace () with the correct boolean expression
        ...
        std::cin >> m;
        bool isEitherPositive = (l>0 || m>0 || (l>0 && m>0) ); //Replace () with the correct boolean expression
        ...
        std::cin >> p;
        bool onlyOneTrue = (n==1 && o==0 && p==0) || (n==0 && o==1 && p==0) || (n==0&& o==0 && p==1); //Replace () with the correct boolean expression
